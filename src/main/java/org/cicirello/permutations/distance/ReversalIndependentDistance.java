...
/**
 * This class implements the concept of a reversal independent distance measure. This is relevant if
 * the permutation and its reverse have the same problem dependent interpretation.
 *
 * <p>In this case, this class computes the minimum of distance(p1,p2) and distance(p1,reverse(p2))
 * for a given distance measure passed as a parameter to the constructor.
 *
...
public final class ReversalIndependentDistance implements PermutationDistanceMeasurer {
  ...
  /**
   * Measures the distance between two permutations, with reversal independence: distance = min {
   * distance(p1,p2), distance(p1,reverse(p2)) }
   *
