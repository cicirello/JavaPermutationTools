...
/**
 * Acyclic edge distance treats the permutations as if they represent sets of edges, and counts the
 * number of edges that differ.
 *
 * <p>Consider the example permutation: [1, 5, 2, 4, 0, 3]. Acyclic edge distance treats this as
 * equivalent to the set of undirected edges: {(1,5), (5,2), (2,4), (4,0), (0,3)}.
 *
 * <p>E.g., distance between [1, 5, 2, 4, 0, 3] and [ 5, 1, 4, 0, 3, 2] is 2. Why? Well, the first
 * permutation has the edges: {(1,5), (5,2), (2,4), (4,0), (0,3)}. The second has three of these
 * (5,1), which is the same as (1,5) since they are undirected edges, (4,0), and (0,3), but does not
 * include two of the edges: (5,2), (2,4)
 *
...
public final class AcyclicEdgeDistance implements NormalizedPermutationDistanceMeasurer {
  ...
  public int distance(Permutation p1, Permutation p2) {
    ...
    for (int i = 0; i < p1.length() - 1; i++) {
      if (p1.get(i + 1) != successors2[p1.get(i)] && p1.get(i) != successors2[p1.get(i + 1)])
        countNonSharedEdges++;
    }
