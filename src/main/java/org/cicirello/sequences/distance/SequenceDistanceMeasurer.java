 ...
 *
 * <p>This interface extends the {@link SequenceDistanceMeasurerDouble} interface, providing default
 ...
 * have a reason to implement the distancef methods of {@link SequenceDistanceMeasurerDouble}.
 *
 * <p>If your sequences are guaranteed not to contain duplicates, and the pair is guaranteed to
 * contain the same set of elements, and are of the same length, then consider instead using the
 * classes that implement the {@link org.cicirello.permutations.distance.PermutationDistanceMeasurer
 * PermutationDistanceMeasurer} interface. Those classes are specifically for distance between
...
public interface SequenceDistanceMeasurer extends SequenceDistanceMeasurerDouble {
  ...
  /**
   * Measures the distance between two arrays of objects. The objects in the arrays must be of a
   * class that has overridden the Object.equals method.
   *
   * @param s1 First array.
   * @param s2 Second array.
   * @return distance between s1 and s2
  ...
  /**
   * Measures the distance between two lists of objects. The objects in the lists must be of a class
   * that has overridden the Object.equals method.
   *
   * @param s1 First list.
