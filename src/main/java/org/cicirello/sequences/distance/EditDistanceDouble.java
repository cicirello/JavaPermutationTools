...
/**
 * <p>EditDistanceDouble is an implementation of Wagner and Fischer's dynamic programming algorithm for computing string edit distance.
 * This class supports double-valued costs, while the {@link EditDistance} class supports both double-valued as well as int-valued 
 * costs. If your costs are int-valued, the {@link EditDistance} class may be slightly faster, but not asymptotically faster. If your
 * costs are double-valued, there should be no difference (one is a subclass of the other).</p>
 * 
 ...
 *
 * <p>The edit distance is parameterized by costs for the edit operations. The constructor enables you to specify
 * 3 costs as values of type double, 1 for each type of edit operation.</p>
 *
 * <p>This class supports computing edit distance for Java String objects or arrays of any of the primitive types, or arrays of objects. 
 ...
 *
 * <p>Another class, {@link org.cicirello.permutations.distance.EditDistance}, is available if you need to compute distance specifically between permutations,
 * rather than general sequences. That class computes distance between permutations
