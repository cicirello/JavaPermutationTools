...
/**
 * Internal package access interface for use by two alternative implementations of the 
 * relabeling phase for the two different algorithms for computing Kendall Tau Sequence 
 * Distance.
 *
...
interface KendallTauRelabeler {
	...
	/**
	 * Relabels the elements of the sequence to integers from 0 to k where
	 * there are k+1 distinct elements in the sequences.
	 *
	 * @param s1 The first sequence.
	 * @param s2 The second sequence.
	 * @param relabeling Buffer for the result, where number of rows should be same as that of the sequences
	 * and with two columns, one for each sequence.
	 *
