...
/**
 * <p>SequencePoolSampler is a class of utility methods for 
 * efficiently generating random samples of array elements, without replacement.</p>
 *
 * <p>The methods of this class implement the algorithm SELECT of S. Goodman and S. Hedetniemi, as described in:
